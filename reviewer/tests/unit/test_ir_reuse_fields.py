...
def test_schema_version_is_one_five_zero() -> None:
    """1.3.0 is where these members arrived; 006 T013 and 010 T077 bumped the minor again
    beside them and left them exactly as they were."""
