...
def test_schema_version_is_one_six_zero() -> None:
    """1.3.0 is where these members arrived; 006 T013, 010 T077 and 011 T006 bumped the minor
    again beside them and left them exactly as they were."""
