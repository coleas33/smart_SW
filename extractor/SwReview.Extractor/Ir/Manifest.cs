...
public sealed class DumpPhase
{
    ...
    /// "manifest", "mate", "feature", "equation", "cutlist", "drawing", "hole", "tolerance",
    /// "fastener", "face", "body" (schema 1.4.0 added "cutlist" and "drawing", 1.5.0
    /// "tolerance"). The same list the Python
