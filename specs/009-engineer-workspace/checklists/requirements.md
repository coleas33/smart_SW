...
- Re-validated 2026-09-23 after the owner's decision 2A amended FR-027 (research R2.28: whole, named titles only where a person reads them; the title the model reads unchanged). Every item still holds: the amendment states what the engineer reads and what must not change for the model, and names no module or function. FR-027 is met by the code: T061, T062 and T065 landed.
