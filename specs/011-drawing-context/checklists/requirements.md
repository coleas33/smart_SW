...
- Re-validated 2026-09-23 after the owner's answers to research R5 Q2 to Q9. Q2 (yes: the product opens a confirmed candidate read-only) is the one answer that moved the spec: User Story 5 gained acceptance scenarios 5 to 7 and six edge cases, FR-036 was amended, FR-003, FR-006, FR-007 and FR-015 name the one exception, FR-053 to FR-056 and SC-011 were added, and the Assumptions record Q2 to Q7 as answered. Every item above still holds: the new requirements are testable (FR-053 to FR-056 with fakes, SC-011 at the seat), name no module or interop member, and keep the feature's one write rule (nothing is changed or saved; FR-052 unchanged). Q3, Q5, Q6, Q7 and Q9 confirmed the shipped defaults; Q4 keeps fictional placeholders; Q1 stays open.
- Re-validated 2026-09-23 against the spec as the tasks landed (T060), after the review of the same day. Every item above still holds. The review's corrections moved behaviour inside requirements that already stated it, and no requirement's wording: FR-023 (a drawing's disagreeing evidence now includes an ISO 2768-governed dimension beside a written precision, and a radius beside a diameter), FR-021 (a radius's written precision gets the band doubled for the diameter), FR-024 and the spec's edge case on PDF evidence (a PDF-ingested sheet is hidden by its native twin only once the seat has validated native evidence), FR-046 (a drawing a confirmed read adds is compared with the profile before the review resumes), FR-005 and SC-009 (every writer of the families any drawing read touches, in every spelling a call site could use), FR-055 (the product closes a drawing it opened whatever fails after the open) and FR-056 (a refused confirmed read leaves the review's bridge working). FR-050 is met on the arrays it names; a standards run's arrays with checks first off exceed the ceiling because of the drawing family and wait on the owner (research R5 Q10), which bounds the claim and changes no requirement. Owner-dependent and not blocking: Q1 (the base repository, T061) and Q10; the seat tasks T062 to T068 and T077; T073 and T074, the add-in's half of the confirmed read.
