...
writer of the 24 drawing families and the named members of the two shared families
...
621 names are new; 633 distinct names match the writer grammar on the 24 families.
...
Interfaces of the 24 whose every writer was already denied: `IGtolFrame` (`AddIndicator`, `DeleteIndicator`, `SetFrameToleranceType`, `SetIndicator`, `SetSymbolXml`).
Interfaces of the 24 with no writer on this interop: `IGeneralTableFeature`, `ITitleBlockTableFeature`, `IMultiJogLeader`.
