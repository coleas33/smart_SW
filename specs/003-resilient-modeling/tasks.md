...
**Tests**: REQUIRED. Tests precede implementation in every phase; feature 001 and 002 golden baselines must stay byte-identical; the feature 001 finding contract is unchanged.
...
- Feature 001 and 002 goldens must remain byte-identical; the IR bump adds optional members only; the finding contract is unchanged.
